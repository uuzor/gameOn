...
pub mod battlechain_v2 {
    ...
    // Missing apply_trait_bundle context
    pub fn apply_trait_bundle_context(ctx: Context<ApplyTraitBundle>, bundle: TraitBundle) -> Result<()> {
        apply_trait_bundle(ctx, bundle)
    }
}
